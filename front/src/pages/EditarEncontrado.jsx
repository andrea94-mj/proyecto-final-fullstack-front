    ...
    const cargarMascota = async () => {
      try {
        ...
        if (response.ok) {
          ...
          const fecha = mascota.fecha_encontrado ? new Date(mascota.fecha_encontrado) : new Date();
          ...
          setFormData({
            ...
            lugar_encontrado: mascota.lugar_encontrado || '',
            fecha_encontrado: fechaFormateada,
  ...
  return (
    <article className='Article-form--mascota'>
      ...
      <form className='Form-mascota' onSubmit={handleSubmit}>
        ...
        {/* Campo para lugar encontrado */}
        <div>
          <label>¿Dónde se encontró?</label>
          <input 
            type="text"
        ...
        <div>
          <label>¿Cuándo se encontró?</label>
          <input 
            type="date"
...
export default EditarEncontrado;